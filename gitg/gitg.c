...
static gchar *loaded_select_sha1 = NULL;
...
static GOptionEntry entries[] = 
{
	...
	{ "select", 's', 0, G_OPTION_ARG_STRING, &loaded_select_sha1, N_("Select the commit with the given SHA1 after loading") },
	{ NULL }
};
...
main(int argc, char **argv)
{
	...
	gitg_window_load_repository(window, argc > 1 ? argv[1] : NULL, argc - 2, (gchar const **)&argv[2], loaded_select_sha1);
